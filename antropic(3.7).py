...
async def main():
    model_client = AnthropicChatCompletionClient(model="claude-3-7-sonnet-20250219",api_key=api_key)
...
"""
    ...
    system_message=f"""### INSTRUCTION ###
      ...
      You MUST provide detailed, data-driven insights using the information that you have and structure your output exactly in the format below.
    ...
    supervisor = AssistantAgent(
        ...
        system_message="""### Instruction###
         ...
         4. If the user asks for a market analysis at any time, jump to **MarketResearcher**; resume the fixed order afterwards.  
    ...
    team = SelectorGroupChat(
        participants=[user_proxy,supervisor, idea_enhancer, estimator_agent, ba_agent, market_agent, swot_agent, gtm_agent, build_vs_outsource_agent],
        model_client=model_client,
