...
Begin when ready. Remember: use both google_search, duckduckgo_search for each query.
""",
    tools=[google_search, duckduckgo_search]
)
    ...
    You strictly have to use the information that has been provided by the agents before you and not use your own memory to manufacture facts. If for a particular use case the information is not provided then you can just specify- "No Information".
...
# )
    ...
    supervisor = AssistantAgent(
        ...
        system_message="""### Instruction###
         ...
         6. EstimatorAgent       -   reveives the GTM strategy (if any changes are made to the budget or anything- also check in with the IdeaEnhancer to confirm the Idea/Set of features.)
         7. Build_vs_Outsource_Advisor-  receives completed Estimations  
    ...
    team = SelectorGroupChat(
        participants=[user_proxy,supervisor, idea_enhancer,market_questionnaire, estimator_agent, ba_agent, market_agent, gtm_agent, build_vs_outsource_agent],
        model_client=model_client,
